...
int main(int argc, char *argv[])
{
    ...
    VMemory_Memory *const vmem = top->Memory;
    ...
    VL_PRINTF("mem addr lsb %08x\n", vmem->mem[10]);
    std::cout << std::bitset<32>(vmem->mem[10]) << std::endl;
    ...
    // shadows any contained modules or variables.
